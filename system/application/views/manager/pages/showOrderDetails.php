<div class='content'>
	...
	<form class='admin-inside' id="detailsForm" action="<?=$selfurl?>updateOdetailStatuses#order" method="POST">
	...
	<form class='comments' action='<?=$selfurl?>addOrderComment/<?=$order->order_id?>#comments' method='POST'>
		<?if (!$comments):?>
			<div class='comment'>

<form method="POST" action="https://merchant.webmoney.ru/lmi/payment.asp" name="postform">
	...
	LMI_PAYMENT_DESC:<input type="text" name="LMI_PAYMENT_DESC" value="Пополнение счета пользователем №<?=$user->user_id;?> на сумму <?=$green?> у.е."><br />
	...
	User_comment:<input type="text" name="User_comment" value="<?=$comment?>"><br />
</form>

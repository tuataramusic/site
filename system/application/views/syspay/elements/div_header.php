	...
	<div class='top-block'>
		<div class='block-user'>
			...
			<div class='center-block'>
				...
				<p>Общий баланс: <span class='big-text'><?=$user->user_coints;?> руб.</span></p>
				<p><a href='/client/showAddBalance'>Пополнить</a></p>
				<p>(<a href='/syspay/showPays/' class='anthracite-color'>Как пополнить?</a>)</p>
				<p><a href='/client/showPaymentHistory'>Статистика платежей</a></p>
				<p><a href='/client/showOutMoney'>Заявка на вывод денег</a></p>
			</div>
		</div>
	</div>
